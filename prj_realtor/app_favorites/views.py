...
from app_favorites.models import Order
...
class FavoriteAddFlat(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return redirect(reverse('app_apartments:list_apartment'))
...
class FavoriteRemoveFlat(TemplateView):
...
class FavoriteRemoveAll(TemplateView):
    """ Класс-представление для удаления товара из корзины"""
    model = Accommodation
    template_name = 'favorites/favorites_detail.html'
